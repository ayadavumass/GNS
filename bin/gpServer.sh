...
echo -e "use jars and classes from default location if available\n"
...
echo -e "developers can use quick build\n"
...
echo -e "Wipe out any existing classpath\n"
...
echo -e "remove classpath from args"
...
echo -e "separate out gigapaxos.properties and appArgs\n"
declare -a args
index=1
start_stop_found=0
for arg in "$@"; do
...
echo -e "gigapaxos properties file must exist at this point\n"
...
echo -e "set servers to start here\n"
if [[ ${args[1]} == "all" ]]; then
