 ...
 * @author ayadav
 */
public class NonBlockingSelectNear extends AbstractNonBlockingSelectCmd
{

	public NonBlockingSelectNear(CommandPacket wosignCmd, AbstractCommand blockingSelectCmd) 
	{
