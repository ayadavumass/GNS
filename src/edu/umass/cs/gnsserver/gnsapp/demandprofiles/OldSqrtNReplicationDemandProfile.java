 ...
 * @author ayadav
 */
public class OldSqrtNReplicationDemandProfile extends AbstractDemandProfile 
{
	private static final Logger LOG = Logger.getLogger(OldSqrtNReplicationDemandProfile.class.getName());
	...
	private enum Keys 
	{
	  ...
	  private OldSqrtNReplicationDemandProfile lastReconfiguredProfile = null;
	  private VotesMap votesMap = new VotesMap();
	  private int lookupCount = 0;
	  private int updateCount = 0;
	  
	  
	  public OldSqrtNReplicationDemandProfile(String name) 
	  {
		  super(name);
	   ...
	   * @param dp
	   */
	  public OldSqrtNReplicationDemandProfile(OldSqrtNReplicationDemandProfile dp) {
	    super(dp.name);
	   ...
	   */
	  public OldSqrtNReplicationDemandProfile(JSONObject json) throws JSONException 
	  {
	   ...
	   */
	  public static OldSqrtNReplicationDemandProfile createDemandProfile(String name) 
	  {
		  LOG.log(Level.FINE, "createDemandProfile called "+name);
		  return new OldSqrtNReplicationDemandProfile(name);
	  }
	  ...
	  public OldSqrtNReplicationDemandProfile clone() 
	  {
		  LOG.log(Level.FINE, "clone() called "+this.name+" "+this.reconfigurationHappened);
		  return new OldSqrtNReplicationDemandProfile(this);
	  }
	  ...
	  public void combine(AbstractDemandProfile dp) 
	  {
		  ...
		  OldSqrtNReplicationDemandProfile update = (OldSqrtNReplicationDemandProfile) dp;
	  ...
	  public static void main(String[] args)
	  {
		  ...
		  OldSqrtNReplicationDemandProfile dp = new OldSqrtNReplicationDemandProfile(guid);
