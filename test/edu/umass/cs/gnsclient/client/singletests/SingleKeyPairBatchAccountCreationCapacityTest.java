...
public class SingleKeyPairBatchAccountCreationCapacityTest extends DefaultGNSTest
{
	static 
	{
		CapacityConfig.load();
	...
	public SingleKeyPairBatchAccountCreationCapacityTest()
	{
	}
	
	@Test
	public void test_1_accountBatchCreationWithSingleKeypair() throws NoSuchAlgorithmException
	{	
		...
		AccountGUIDRequestSender accountGuidRequestSender = 
				new AccountGUIDRequestSender(PROBE_RUN_DURATION, alias, ALIAS_SUFFIX, 
						AccountCreationMode.MULTIPLE_BATCH_ACCOUNT_GUID_SINGLE_KEYPAIR, THREAD_POOL, client);
